Creature_C99D {
	...
	*get {
		^( instance ?? { instance = Creature_C99D.new(-1, -1)});
	}
	...
	*initClass {
	...
	init {| id, synthID |
		...
		this.synthParams.freqStartScalar = 56;
		this.synthParams.freqStartOffset = 112;

		this.synthParams.centerFreqEnd = 440;
		this.synthParams.freqEndScalar = 56;
		this.synthParams.freqEndOffset = 112;
						...
						Routine({
							...
							loop({
								Server.local.sendMsg("s_new",
									this.synthID, -1, 0, 0,
									\freq_start, (((instance.synthParams.freqStartOffset-currentNode.at(0))/
										instance.synthParams.freqStartScalar)*instance.synthParams.centerFreqStart),
									\freq_end, (((instance.synthParams.freqEndOffset-currentNode.at(0))/
										instance.synthParams.freqEndScalar)*
